...
NOTE: The desktop and Android GUI use Tauri 2 in `src-tauri2`. The Cordova build in `cube_shuffle-cordova` remains available but is deprecated; use `src-tauri2` for Windows and Android.
